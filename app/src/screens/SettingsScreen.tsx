...
const styles = StyleSheet.create({
  ...
  vesselName: { fontSize: 17, fontWeight: '600', color: theme.colors.text, padding: 0 },
  vesselSub: { fontSize: 12.5, color: theme.colors.textMuted, marginTop: 2 },
  groupTitle: {
    fontSize: 13,
    fontWeight: '600',
    letterSpacing: 1.5,
  ...
  footerText: { fontSize: 11, color: theme.colors.textMuted, letterSpacing: 1 },
});
